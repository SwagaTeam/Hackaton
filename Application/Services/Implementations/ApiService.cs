        ...
        var requestBody = new
        {
            contents = new[]
            {
                new
                {
                    ...
                    parts = new[]
                    {
                        new { text = "Ты помогаешь студенту понять учебный материал. Сделай краткое и ясное резюме этого текста простым языком, без лишних символов." },
        ...
        var requestBody = new
        {
            contents = new[]
            {
                new
                {
                    ...
                    parts = new[]
                    {
                        new { text = "Ты помощник, отвечай кратко и понятно по теме материала. Дай ответ простым языком без лишних символов" },
                        new { text = $"Материал:\n{block}\n\nВопрос: {question}" }
                    }
                }
            }
